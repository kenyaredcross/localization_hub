...
`], ...formatTraceEntry(entry));
  ...
  **/
          ...
          : ($options.filteredDatasets.length > 0)
                    ...
                    return (openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_27$1, [
                        createBaseVNode("button", {
                          ...
                          _cache[6] || (_cache[6] = createBaseVNode("span", { class: "btn-icon" }, "⬇", -1 /* CACHED */)),
                          createBaseVNode("span", _hoisted_29$1, toDisplayString(dataset.file_format || 'Download'), 1 /* TEXT */)
                        ], 8 /* PROPS */, _hoisted_28$1),
                        (dataset.documentation_url)
                          ? (openBlock(), createElementBlock("button", {
                              ...
                              createBaseVNode("span", { class: "btn-text" }, "Documentation", -1 /* CACHED */)
                            ]))], 8 /* PROPS */, _hoisted_30$1))
                          : createCommentVNode("v-if", true)
                      ])
                    ]))
                  }), 128 /* KEYED_FRAGMENT */))
            ...
            : (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                ...
                createBaseVNode("div", _hoisted_31$1, [
                  _cache[8] || (_cache[8] = createBaseVNode("div", { class: "empty-icon" }, "📂", -1 /* CACHED */)),
                  _cache[9] || (_cache[9] = createBaseVNode("p", { class: "empty-text" }, "No datasets found", -1 /* CACHED */)),
                  createBaseVNode("p", _hoisted_32$1, toDisplayString($data.selectedCategory === 'all' 
  ...
  const _hoisted_31 = { class: "language-dropdown-header" };
  const _hoisted_32 = ["onClick"];
  const _hoisted_33 = { class: "lang-flag" };
  const _hoisted_34 = { class: "lang-name" };
  const _hoisted_35 = {
    key: 0,
    class: "checkmark"
  };
      ...
      createBaseVNode("div", _hoisted_25, [
        ...
        createBaseVNode("div", _hoisted_46, [
          ...
          ($data.currentPage === 'profile')
            ? (openBlock(), createBlock(_component_ProfilePage, {
                key: 1,
                "user-name": $data.userName,
                "user-email": $data.userEmail
              }, null, 8 /* PROPS */, ["user-name", "user-email"]))
            : createCommentVNode("v-if", true),
          ($data.currentPage === 'data')
            ? (openBlock(), createBlock(_component_DataPage, { key: 2 }))
            : createCommentVNode("v-if", true),
          ($data.currentPage === 'publication')
            ? (openBlock(), createBlock(_component_PublicationPage, { key: 3 }))
            : createCommentVNode("v-if", true),
  ...
  script.__scopeId = "data-v-11a43918";
  script.__file = "localization_hub/public/js/dashboard/App.vue";
